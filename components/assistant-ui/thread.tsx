...
const WelcomeIntro: FC = () => {
  return (
      <m.div
        ...
        exit={{ opacity: 0, y: 10 }}
      >
          <div className="max-w-3xl mx-auto p-6 space-y-6 text-gray-800 leading-relaxed">
            <p className="text-gray-500">
              欢迎使用课程排课智能体，输入信息即可生成课表并导出
              <span className="font-semibold text-gray-500"> .xlsx 文件</span>
            </p>
            ...
            {/* List */}
            <ol className="list-disc pl-6 space-y-0 mt-0">
              <li>日历年月（例如：2026年7月）</li>
              <li>课程名称（例如：科学）</li>
              <li>上课时段（例如：09:00-11:30）</li>
              <li>上课日期（例如：7月1日至7月15日）</li>
            </ol>
            ...
            {/* Code-like block */}
            <div className="bg-gray-100 rounded-lg p-4 font-mono text-sm space-y-1 border">
              <div>2026年7月，科学，7月6日至7月24日每天（不包含周日），12:50~14:50</div>
              <div>2026年7月，游泳，7月9日至7月23日每天，17:00~18:00</div>
              <div>2026年8月，足球，每周二、周四、周六，8:30~10:00；每周日，10:10~11:40</div>
            </div>
          </div>
      </m.div>
  );
  ...
  return (
    ...
    >
      <ActionBarPrimitive.Edit asChild>
        <TooltipIconButton tooltip="修改" className="aui-user-action-edit p-4">
          <PencilIcon />
        </TooltipIconButton>
